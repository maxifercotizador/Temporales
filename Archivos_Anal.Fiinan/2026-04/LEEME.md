...
- [ ] `extracto_galicia.xlsx` — Movimientos Galicia 01/04 al 30/04
- [ ] `resumen_santander.pdf` — Resumen Santander del mes (cierra ~26/05)
- [ ] `cobranzas.txt` — `total_cobrado / cantidad / cobrado_papa`
- [ ] `saldos.txt` — `galicia / santander / usd` al 30/04
